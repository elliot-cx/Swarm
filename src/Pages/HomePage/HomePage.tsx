    ...
    const tutorial = () => {
        return(
            <div className={styles.tutorial}>
                ...
                <p>Après avoir créé une room, vous pourrez la <b>selectionner et l&aposadministrer</b>.</p>
                <p>Ajoutez jusqu&aposà 16 bots (par room) du type de votre choix et <b>envoyez la sauce</b> !</p>
                <h4>Etat des bots et contrôle de leurs actions</h4>
                <p>Swarm affiche en temps réel <b>l&aposétat de chaque bot</b> (connecté, banni, déconnecté etc..)</p>
            </div>
        );
    };
    return(
